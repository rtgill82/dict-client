...
class ClassConvert
{
  public static List<Dictionary> convertDictionaryList(List<org.lonestar.sdf.locke.libs.dict.Dictionary> dictionaries,
                                                       Host host)
  {
  ...
  public static List<Strategy> convertStrategyList (List<org.lonestar.sdf.locke.libs.dict.Strategy> strategies,
                                                    Host host)
  {
